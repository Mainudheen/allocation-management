...
export default function StudentManager() {
  const [step, setStep] = useState("main"); // main | add | delete | singleAdd | bulkAdd | singleDelete | bulkDelete
  ...
  //w-full max-w-3xl
  // ✅ UI rendering p-6 flex justify-center items-center min-h-screen bg-gray-100
  return (
